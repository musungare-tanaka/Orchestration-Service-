CREATE SCHEMA IF NOT EXISTS orchestration_service;
CREATE TABLE IF NOT EXISTS orchestration_service.stage_ledger (
 deployment_id text NOT NULL, stage text NOT NULL,
 state text NOT NULL CHECK(state IN ('IN_PROGRESS','COMPLETED','FAILED')),
 attempt integer NOT NULL DEFAULT 1 CHECK(attempt>0), lease_expires_at timestamptz,
